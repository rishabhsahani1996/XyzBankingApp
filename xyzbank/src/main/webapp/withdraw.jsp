...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" style=; background-color:#FFFFFF">
  ...
  <td colspan="2"><table width="98%" border="0px" align="center" cellpadding="0" cellspacing="0">
	...
	<form action="accounts/subtract" method="post">
	<table border= 5px solid black align="center" vertical-align="center" padding-top=15px>
	<tr>
	<th>Enter amount you want to withdraw:
	<th><input type="number" name="withdraw" required autofocus /> </th></th>
	</tr>
	</table>
	<br>
	<div align="center">
