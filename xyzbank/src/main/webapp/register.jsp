...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" style=; background-color:#FFFFFF">
  ...
  <td colspan="2"><table width="98%" border="0px" align="center" cellpadding="0" cellspacing="0">
	...
	<h2 align="center" style="color:grey;">Enter User details</h2>
	<form action="../accounts/save" method="post">
	<table align="center" border=1>
	<tr>
	<th>User Full Name
	<th><input type="text" name="fullName" required autofocus /> </th></th>
	</tr>
	<tr>
	<th>User Password
	<th><input type="password" name="password" required autofocus /> </th></th>
	</tr>
	<tr>
	<th>Balance
	<th><input type="text" name="balance" required autofocus /> </th></th>
	</tr>
	</table>
	<div align="center">
