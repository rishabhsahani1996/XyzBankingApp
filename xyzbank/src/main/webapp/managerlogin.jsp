...
<h3 style="color:grey;" align="center">Enter Login details</h3>
	<form action="accounts/checkmanager" method="post">
	<table align="center" border=1>
	<tr>
	<th>Manager Name:
	<th><input type="text" name="user" required autofocus /> </th></th>
	</tr>
	<tr>
	<th>Manager Password:
	<th><input type="text" name="password" required autofocus /> </th></th>
	</tr>
	</table>
	<div align="center">
